...
namespace SperarateAccount\Gateways;
...
abstract class Wechat extends GatewayInterface
{
    ...
    protected $gateway_profit = 'https://api.mch.weixin.qq.com/secapi/pay/profitsharing';
    protected $gateway_multiprofit = 'https://api.mch.weixin.qq.com/secapi/pay/multiprofitsharing';
    protected $gateway_profitquery = 'https://api.mch.weixin.qq.com/pay/profitsharingquery';
    protected $gateway_addreceiver = 'https://api.mch.weixin.qq.com/pay/profitsharingaddreceiver';
    protected $gateway_removereceiver = 'https://api.mch.weixin.qq.com/pay/profitsharingremovereceiver';
    protected $gateway_profitfinish = 'https://api.mch.weixin.qq.com/secapi/pay/profitsharingfinish';
    protected $gateway_profitreturn = 'https://api.mch.weixin.qq.com/secapi/pay/profitsharingreturn';
    protected $gateway_profitreturnquery = 'https://api.mch.weixin.qq.com/pay/profitsharingreturnquery';
...
//            $this->gateway_ras_public = 'https://fraud.mch.weixin.qq.com/sandboxnew/risk/getpublickey';
    ...
    public function verify($data, $sign = null, $sync = false)
    {
        ...
        return $this->getHashSign($data) === $sign ? $data : false;
    }
    ...
    protected function getResult($url, $cert = false)
    {
        ...
        if (!isset($data['return_code']) || $data['return_code'] !== 'SUCCESS' || $data['result_code'] !== 'SUCCESS') {
            $error = 'ResultError:';
            $error .= isset($data['return_msg'])?$data['return_msg'].'-':'';
            $error .= isset($data['err_code_des']) ? $data['err_code_des'] : '';
        }
        if (isset($data['sign'])) {
            if (!isset($error) && $this->getHashSign($data) !== $data['sign']) {
    ...
    protected function getHashSign($data)
    {
        if (is_null($this->userConfig->get('mch_key'))) {
            throw new InvalidArgumentException('Missing Config -- [mch_key]');
        }
